...
/// <summary>
/// Represents a collection of columns in a <see cref="LRS.UserControls.TableView.TableView"/>, providing functionality to manage and interact with the columns.
/// </summary>
...
public interface ITableViewColumnsCollection : IList<TableViewColumn>, INotifyCollectionChanged
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="LRS.UserControls.TableView.TableView"/> associated with the collection.
    /// </summary>
    /// <remarks>
    /// This property allows access to the <see cref="LRS.UserControls.TableView.TableView"/> that owns this collection of columns.
    /// </remarks>
