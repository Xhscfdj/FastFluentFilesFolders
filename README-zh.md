...
- **插件系统** -- 用插件扩展该程序的功能吧喵！默认带有压缩/解压缩/预览压缩包插件！开发详细文档见：[文档](https://github.com/Xhscfdj/FastFluentFilesFolders/FastFluentFilesFolders/Extensions/PLUGIN_DEV_GUIDE.md)
- **还会有更多喵!**
### 性能
